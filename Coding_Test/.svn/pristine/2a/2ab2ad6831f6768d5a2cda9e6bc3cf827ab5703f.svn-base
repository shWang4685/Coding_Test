...
public class TestResultListener extends TestListenerAdapter {
    ...
    protected ITestContext testContext = null; // 这里也是新加
    String  browser = null;
    ...
    public void onStart(ITestContext testContext) { // 这里也是新加的，用于对context进行统一
        ...
        logger.info("[browserName]"+testContext.getCurrentXmlTest().getParameter("browserName"));
    ...
    public void onTestStart(ITestResult tr) {
        ...
        logger.info(tr.getName() + " 测试用例始执行！");
    }
